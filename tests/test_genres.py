...
class TestGenre(TestCase):
    ...
    def test_get_genres_by_sub_genres_haschildren_false_return_genre_with_haschildren_false(
        self,
    ):
    ...
    def test_get_genres_by_sub_genres_haschildren_true_return_genre_with_haschildren_true(
        self,
    ):
