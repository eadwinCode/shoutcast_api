...
def get_top_500(k, limit=None, **kwargs) -> StationList:
    """
...
def get_stations_keywords(k, search, limit=None, **kwargs) -> StationList:
    """
...
def get_stations_by_genre(k, genre, limit=None, **kwargs) -> StationList:
    """
...
def get_stations_by_now_playing(k, ct, limit=None, **kwargs) -> StationList:
    """
...
def get_stations_bitrate_or_genre_id(k, br: int = 128,
                                     genre_id: int = None, limit=None, **kwargs) -> StationList:
    """
          Get stations which match the genre specified as query.
...
def get_random_station(k, limit=None, **kwargs):
    """
